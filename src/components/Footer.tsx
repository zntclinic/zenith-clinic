      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-start">
            <h3 className="font-playfair text-2xl font-bold text-white mb-4">{businessInfo.name}</h3>
            <div className="flex gap-3 mb-6">
              <a
                href={businessInfo.social.instagram}
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 border border-white/30 rounded-full flex items-center justify-center hover:bg-pink-500/20 hover:border-pink-500/50 transition-colors group"
              >
                <InstagramIcon className="text-white w-4 h-4 group-hover:text-pink-400 transition-colors" />
              </a>
              <a
                href={`mailto:${businessInfo.contact.email}`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 border border-white/30 rounded-full flex items-center justify-center hover:bg-red-500/20 hover:border-red-500/50 transition-colors group"
              >
                <GmailIcon className="text-white w-4 h-4 group-hover:text-red-400 transition-colors" />
              </a>
            </div>
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2 text-white/80">
                ...
                <span>{businessInfo.contact.phoneFormatted}</span>
              </div>
            </div>
          </div>
        </div>
